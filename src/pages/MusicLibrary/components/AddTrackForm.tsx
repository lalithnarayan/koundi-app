...
const AddTrackForm: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const validateForm = () => {
    ...
    if (formState.isNewAlbum) {
      ...
      if (
        formState.newAlbumCoverUrl &&
        !isValidUrl(formState.newAlbumCoverUrl)
      ) {
    ...
    >
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="col-span-2">
          ...
          {errors.selectedAlbumId && (
            <p className="text-red-500">{errors.selectedAlbumId}</p>
          )}
        </div>
      </div>
